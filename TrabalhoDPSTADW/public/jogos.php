...
<body>
    ...
    <div class="jogos-container">
        ...
        foreach ($jogos as $jogo) {
            ...
            if ($_SESSION['tipo'] === 'A') {
                echo "<td><a href='../controle/deletarJogo.php?id=$idjogo' class='delete-btn' onclick='return confirm(\"Tem certeza que deseja excluir este jogo?\");'><i class='fas fa-trash'></i> Excluir</a></td>";
            }
